...
namespace MakeLand
{
    public partial class Form1 : Form
    {
        ...
        public void showNum(int num)
        {
            ...
            Messageline2("Terrain ratio" + "\nseaCount=" + (pt.seaCount / pt.totalCount).ToString("0.##")
                                   + "\nfrestCount=" + (pt.freshCount / pt.totalCount).ToString("0.##")
                                   + "\nlandCount="  + (1-( (pt.seaCount / pt.totalCount) + (pt.freshCount / pt.totalCount))).ToString("0.##")
                                   + "\nTotal=" + (pt.totalCount).ToString());
        }
